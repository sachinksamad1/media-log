...
export class UsersService {
   ...
   */
  async syncUser(uid: string, email: string, data?: Partial<User>): Promise<User> {
  ...
  async checkAvailability(username: string, email: string): Promise<void> {
    ...
    const usernameSnapshot = await db.collection(USERS_COLLECTION)
   ...
   */
  async registerUser(params: { email: string; password: string; username: string; displayName?: string }): Promise<User> {
