...
function syncForm(data: Movie) {
  ...
  form.watchedDate = data.userStats?.watchedDate ?? ''
        ...
        <div class="flex-1 overflow-y-auto p-6">
          ...
          <div v-if="!isEditing" class="space-y-6">
            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
               ...
               <div class="p-3 bg-secondary/30 rounded-lg">
                 <div class="text-xs text-muted-foreground uppercase tracking-wider mb-1">Duration</div>
            ...
            <div v-if="form.director || form.producer" class="grid grid-cols-2 gap-4">
                <div v-if="form.director" class="p-3 bg-secondary/30 rounded-lg">
                    <div class="text-xs text-muted-foreground uppercase tracking-wider mb-1">Director</div>
                    <div class="font-medium">{{ form.director }}</div>
                </div>
                 <div v-if="form.producer" class="p-3 bg-secondary/30 rounded-lg">
                    <div class="text-xs text-muted-foreground uppercase tracking-wider mb-1">Producer</div>
