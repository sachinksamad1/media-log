...
const episodesText = computed(() => {
  const total = props.tvSeries.episodes || '?'
  return `${props.tvSeries.userStats.watchedEpisodes}/${total} Eps`
})
</script>
...
<template>
  ...
  >
    ...
    <!-- Content -->
    <div class="p-4">
      <h4 class="font-semibold text-base line-clamp-1 mb-1" :title="tvSeries.title">{{ tvSeries.title }}</h4>
