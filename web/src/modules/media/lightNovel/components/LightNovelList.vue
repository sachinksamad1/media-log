...
function openDetails(item: LightNovel) {
  selectedLightNovel.value = item
    ...
    <div class="mx-auto w-full max-w-7xl px-2 lg:px-4 py-2">
      ...
      <div class="flex flex-col sm:flex-row items-center justify-between mb-8 gap-4">
        <div class="flex items-center gap-4">
          <h3 class="text-xl font-semibold text-[hsl(var(--category-lightnovel))]">My Light Novel Library</h3>
          <button 
