    ...
    <div class="mx-auto w-full max-w-7xl px-2 lg:px-4 py-2">
      ...
      <div class="flex flex-col sm:flex-row items-center justify-between mb-8 gap-4">
        <div class="flex items-center gap-4">
          <h3 class="text-xl font-semibold text-[hsl(var(--category-nonfiction))]">
            Non-Fiction Library
          </h3>
          <button
          ...
          >
            <span>+</span> Add Non-Fiction
          </button>
        </div>

        <!-- SEARCH BAR -->
        <div class="relative w-full lg:max-w-[200px] order-last sm:order-none mt-4 sm:mt-0">
          ...
          <input
            ...
            placeholder="Search non-fiction..."
          />
        </div>
