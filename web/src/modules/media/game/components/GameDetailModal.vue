...
function syncForm(data: Game) {
  ...
  form.developers = data.developers ? data.developers.join(', ') : ''
  form.publishers = data.publishers ? data.publishers.join(', ') : ''
      ...
      >
        ...
        <div class="flex-1 overflow-y-auto p-6">
          ...
          <div v-if="!isEditing" class="space-y-6">
            ...
            <div v-if="form.developers || form.publishers" class="grid grid-cols-2 gap-4">
              <div v-if="form.developers" class="p-3 bg-secondary/30 rounded-lg">
                <div class="text-xs text-muted-foreground uppercase tracking-wider mb-1">
                  Developers
                </div>
                <div class="font-medium">{{ form.developers }}</div>
              </div>
              <div v-if="form.publishers" class="p-3 bg-secondary/30 rounded-lg">
                <div class="text-xs text-muted-foreground uppercase tracking-wider mb-1">
                  Publishers
                </div>
                <div class="font-medium">{{ form.publishers }}</div>
              </div>
            </div>
