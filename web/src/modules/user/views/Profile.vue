      ...
      <CardContent class="space-y-6">
        <div v-if="userProfile" class="flex flex-col gap-6">
           <div class="flex items-center gap-4">
             <div class="w-20 h-20 rounded-full overflow-hidden bg-secondary flex items-center justify-center border-2 border-border">
                <img v-if="userProfile.avatarImg" :src="userProfile.avatarImg" alt="Avatar" class="w-full h-full object-cover" />
             ...
             <div class="space-y-1">
               ...
               <p v-if="userProfile.displayName" class="text-sm font-medium">{{ userProfile.displayName }}</p>
             </div>
           </div>
