...
const groupedLibrary = computed(() => {
  const groups: Record<string, Fiction[]> = {}
              ...
              <button
                ...
                :class="
                  selectedCategory !== 'All'
                    ? 'border-[hsl(var(--category-fiction))]/40 text-[hsl(var(--category-fiction))]'
                  ...
                  <button
                    ...
                    :class="
                      selectedCategory === cat
                        ? 'font-semibold text-[hsl(var(--category-fiction))]'
                        : 'text-foreground'
                    "
      ...
      >
        {{
          library.length === 0
            ...
            : 'No fiction match the selected filters.'
        }}
      </div>
        ...
        <div v-for="(groupList, groupName) in groupedLibrary" :key="groupName" class="mb-8">
          ...
          >
            <span
              ...
              class="w-1.5 h-1.5 rounded-full bg-[hsl(var(--category-fiction))]"
            ></span>
            {{
              groupName === 'Other'
