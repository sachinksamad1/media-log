      ...
      <div class="flex flex-col gap-6 mb-10">
        ...
        <div class="flex items-center justify-between">
          <div class="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4">
            <h1
              class="text-3xl font-extrabold tracking-tight text-[hsl(var(--category-lightnovel))]"
            >
              Light Novel Library
            </h1>
            <div class="flex items-center gap-2 text-sm text-muted-foreground">
              <span
                class="w-1.5 h-1.5 rounded-full bg-[hsl(var(--category-lightnovel))] animate-pulse"
              ></span>
          ...
          >
            ...
            <span class="hidden sm:inline">Add Light Novel</span>
        ...
        <div class="flex flex-col lg:flex-row items-stretch lg:items-center gap-4">
          ...
          <div class="relative group flex-shrink-0 lg:w-[320px]">
            <Search
              class="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground group-focus-within:text-[hsl(var(--category-lightnovel))] transition-colors"
            />
            <input
              v-model="searchQuery"
              class="w-full pl-10 pr-4 py-2.5 bg-secondary/30 hover:bg-secondary/50 border border-transparent focus:border-[hsl(var(--category-lightnovel))]/30 focus:bg-background rounded-xl outline-none transition-all placeholder:text-muted-foreground text-sm shadow-sm"
              ...
              <button
                ...
                :class="
                  selectedCategory !== 'All'
                    ? 'border-[hsl(var(--category-lightnovel))]/40 text-[hsl(var(--category-lightnovel))]'
                  ...
                  <button
                    ...
                    :class="
                      selectedCategory === cat
                        ? 'font-semibold text-[hsl(var(--category-lightnovel))]'
                        : 'text-foreground'
                    "
      ...
      >
        {{
          library.length === 0
            ...
            : 'No light novels match the selected filters.'
        }}
      </div>
